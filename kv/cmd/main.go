...
import (
	...
	"github.com/gaoxinge/etcd-raft-embed-example/kv/pkg"
)
...
func main() {
	...
	kv1 := pkg.NewKV(0x01, proposeC1, commitC1)
	...
	kv2 := pkg.NewKV(0x02, proposeC2, commitC2)
	...
	kv3 := pkg.NewKV(0x03, proposeC3, commitC3)
